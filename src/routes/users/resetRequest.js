...
module.exports = async (req, res, next) => {
  ...
  const mailOptions = {
    ...
    subject: 'Kwon - Reset Password',
    html: `<p>Hello, ${user.username}!<br> Click on this link to reset your password: <strong>https://kwon.ml/reset-password?unique-id=${user.id}&code=${resetCode}</strong></p>`
  };
